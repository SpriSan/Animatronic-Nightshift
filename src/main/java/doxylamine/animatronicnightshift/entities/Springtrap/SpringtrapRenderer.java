...
public class SpringtrapRenderer extends MobRenderer<Springtrap, ModelSpringtrap<Springtrap>> {
    public SpringtrapRenderer(EntityRendererProvider.Context pContext) {
        super(pContext, new ModelSpringtrap<>(pContext.bakeLayer(LayersRegister.SPRINGTRAP_LAYER)), 0.5f);
    }

    @Override
    public ResourceLocation getTextureLocation(Springtrap pEntity) {
        return new ResourceLocation(AnimatronicNightshift.MODID, "textures/entity/springtrap.png");
    }

    @Override
    public void render(Springtrap pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
