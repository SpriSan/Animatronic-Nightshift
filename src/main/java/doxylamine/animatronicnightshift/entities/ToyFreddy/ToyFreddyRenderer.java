...
public class ToyFreddyRenderer extends MobRenderer<ToyFreddy, ModelToyFreddy<ToyFreddy>> {
    public ToyFreddyRenderer(EntityRendererProvider.Context pContext) {
        super(pContext, new ModelToyFreddy<>(pContext.bakeLayer(LayersRegister.TOY_FREDDY_LAYER)), 0.5f);
    }

    @Override
    public ResourceLocation getTextureLocation(ToyFreddy pEntity) {
        return new ResourceLocation(AnimatronicNightshift.MODID, "textures/entity/toyfreddy.png");
    }

    @Override
    public void render(ToyFreddy pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
