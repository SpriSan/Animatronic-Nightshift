package doxylamine.animatronicnightshift.entities.Chica;// Save this class in your mod and generate all required imports
...
public class ChicaAnimations {
    public static final AnimationDefinition dance = AnimationDefinition.Builder.withLength(3.7917F).looping()
            .addAnimation("tete", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(2.7917F, KeyframeAnimations.degreeVec(0.0F, 27.5F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(3.4583F, KeyframeAnimations.degreeVec(0.0F, 27.5F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            ...
            .addAnimation("corps", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(2.8333F, KeyframeAnimations.degreeVec(0.0F, -20.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(3.4167F, KeyframeAnimations.degreeVec(0.0F, -20.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            ...
            .addAnimation("bone12", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(3.4167F, KeyframeAnimations.degreeVec(-30.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(3.7917F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
            ))
            .addAnimation("bone24", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(-83.5511F, -0.7086F, 94.9557F), AnimationChannel.Interpolations.LINEAR)
            ))
