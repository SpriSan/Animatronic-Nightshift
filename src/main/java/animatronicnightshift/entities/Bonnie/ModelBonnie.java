...
public class ModelBonnie<T extends Bonnie> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r3 = corps.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(28, 78).addBox(0.0F, -1.5F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.75F, -13.25F, -3.475F, 0.0F, 0.0F, -0.3054F));
		...
		.texOffs(17, 79).addBox(-1.3532F, -7.9846F, -0.5F, 3.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, -7.25F, -0.5F, 0.2182F, 0.0F, -0.0436F));

		PartDefinition cube_r11 = oreilledroite.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(26, 82).addBox(-1.0F, -4.0F, -1.0F, 3.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.3532F, -7.9846F, 0.5F, 0.48F, 0.0F, 0.0F));
		...
		.texOffs(17, 79).mirror().addBox(-1.6468F, -7.9846F, -0.5F, 3.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(2.0F, -7.25F, -0.5F, 0.2182F, 0.0F, 0.0436F));
		...
		PartDefinition cube_r13 = jambedroite.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(72, 39).addBox(-3.0F, 7.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.0F, 0.5F, -0.1309F, 0.2182F, 0.0F));

		PartDefinition cube_r14 = jambedroite.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(70, 60).addBox(-2.8049F, -0.9511F, -1.7621F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r15 = jambedroite.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(38, 9).addBox(-3.7767F, -0.6593F, -5.8886F, 4.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.75F, 18.5F, 0.0F, -0.134F, 0.2156F, -0.0318F));

		PartDefinition cube_r16 = jambedroite.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(72, 42).addBox(-2.0213F, -1.941F, -0.1622F, 3.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.1246F, 10.0657F, -2.5718F, 0.2182F, 0.2182F, 0.0F));

		PartDefinition cube_r17 = jambedroite.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(0, 41).addBox(-4.0F, -0.7692F, -1.7063F, 4.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -0.25F, 0.0F, -0.1309F, 0.2182F, 0.0F));
		...
		PartDefinition cube_r18 = jambegauche.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(60, 72).addBox(1.0F, 7.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 1.0F, 0.5F, -0.1309F, -0.2182F, 0.0F));

		PartDefinition cube_r19 = jambegauche.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(70, 68).addBox(0.8049F, -0.9511F, -1.7621F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r20 = jambegauche.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(30, 39).addBox(-0.2233F, -0.6593F, -5.8886F, 4.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.75F, 18.5F, 0.0F, -0.134F, -0.2156F, 0.0318F));

		PartDefinition cube_r21 = jambegauche.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(52, 72).addBox(-0.9787F, -1.941F, -0.1622F, 3.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.1246F, 10.0657F, -2.5718F, 0.2182F, -0.2182F, 0.0F));

		PartDefinition cube_r22 = jambegauche.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(36, 50).addBox(0.0F, -0.7692F, -1.7063F, 4.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, -0.25F, 0.0F, -0.1309F, -0.2182F, 0.0F));
