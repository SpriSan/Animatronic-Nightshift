...
public class FreddyFazbearAnimation {
	...
	public static final AnimationDefinition jumpscare = AnimationDefinition.Builder.withLength(0.1176F).looping()
		.addAnimation("tete", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.1176F, KeyframeAnimations.degreeVec(-6.8042F, -3.1622F, -24.812F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("brasdroit", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
