...
private final ModelPart bone7;
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition cube_r12 = jambedroite.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(0, 41).addBox(-4.0F, -0.7692F, -1.7063F, 4.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -0.25F, 0.0F, -0.1309F, 0.2182F, 0.0F));
        ...
        PartDefinition cube_r15 = bone.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(38, 9).addBox(-3.7767F, -0.6593F, -5.8886F, 4.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 10.0F, 0.0F, -0.134F, 0.2156F, -0.0318F));
        ...
        PartDefinition cube_r17 = jambegauche.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(36, 50).addBox(0.0F, -0.7692F, -1.7063F, 4.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, -0.25F, 0.0F, -0.1309F, -0.2182F, 0.0F));
        ...
        PartDefinition cube_r20 = bone3.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(30, 39).addBox(-0.2233F, -0.6593F, -5.8886F, 4.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, 10.0F, 0.0F, -0.134F, -0.2156F, 0.0318F));
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animate(((FreddyFazbear) entity).crawlingAnimationState, FreddyFazbearAnimation.crawl, ageInTicks, 1f);
